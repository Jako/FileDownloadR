...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
    case xPDOTransport::ACTION_INSTALL:
        $output .= '<h2>Install FileDownloadR</h2>

        <p>Thanks for installing FileDownloadR. This open source extra is
    ...
    case xPDOTransport::ACTION_UPGRADE:
        $output .= '<h2>Upgrade FileDownloadR</h2>

        <p>FileDownloadR will be upgraded. This open source extra is maintained by
