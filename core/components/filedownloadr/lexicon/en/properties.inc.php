...
$_lang['filedownloadr.filedownload.breadcrumbSeparator'] = 'Optional string to separate the parts of the breadcrumb.';
...
$_lang['filedownloadr.filedownload.deleteGroups'] = 'Comma-separated list of user group names. Enable the delete link for users that belong to the specified groups.';
...
$_lang['filedownloadr.filedownload.dirSeparator'] = 'Optional string to separate the directories in one directory group.';
$_lang['filedownloadr.filedownload.dirsSeparator'] = 'Optional string to separate the grouped directories in the directory groups.';
...
$_lang['filedownloadr.filedownload.fileSeparator'] = 'Optional string to separate the files in one directory group.';
$_lang['filedownloadr.filedownload.filesSeparator'] = 'Optional string to separate the grouped files in the directory groups.';
$_lang['filedownloadr.filedownload.getDir'] = 'Comma-separated list of directories. Specify the directories displayed in the snippet output. When multiple directories are specified the directory browsing functionality is disabled.';
...
$_lang['filedownloadr.filedownload.limit'] = 'Limit the number of files in the result. Use "0" for unlimited files. This property is only regarded, when the getDir property contains a single directory.';
...
$_lang['filedownloadr.filedownload.offset'] = 'The offset of events to skip.';
...
$_lang['filedownloadr.filedownload.totalVar'] = 'The key of a placeholder that indicates the total number of files.';
...
$_lang['filedownloadr.filedownloadcount.userGroups'] = 'Comma-separated list of user group names. This will show the download count for users that belong to the specified groups. Users that don’t not belong to this group or are not logged in will receive a message specified in the tplNotAllowed property.';
...
$_lang['filedownloadr.filedownloadlink.userGroups'] = 'Comma-separated list of user group names. Show the file list for users that belong to the specified groups. Users that don’t belong to these groups or that are not logged in will receive a message specified in the tplNotAllowed property.';
