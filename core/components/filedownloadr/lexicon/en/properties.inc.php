...
$_lang['filedownloadr.filedownloadcount.userGroups'] = 'Comma-separated list of user group names. This will show the file list for users that belong to the specified groups. Users that don\'t not belong to this group or are not logged in will receive a message specified in the tplNotAllowed property.';
